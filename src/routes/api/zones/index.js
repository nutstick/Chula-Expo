...
//----------------------------------------------------------------  
  ...
  if (req.query.fields) {
   ...
   req.query.fields.split(',').forEach(function(elemnent){

    if(element===name) element=name.en;
 ...
 */
 router.post('/', (req, res, next) => {
  ...
  zone.welcomeMessage = req.body.welcomeMessage;
  zone.shortName = req.body.shortName;
  zone.description = req.body.description;
  zone.websiteUrl = req.body.websiteUrl;
  zone.type = req.body.type;
  zone.webpage=req.body.webpage;
