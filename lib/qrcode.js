...
qrcode.decode = function(src){
    ...
    {
        var canvas_qr = document.querySelector('qr-scanner-lite').shadowRoot.getElementById('qr-canvas') || document.querySelector('qr-scanner').shadowRoot.getElementById("qr-canvas");
