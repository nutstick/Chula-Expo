...
! function() {
    ...
    var l = [
        ...
        q = p ? o : m() ? function() {
            ...
            var e = function(a, b) {
                this._bIsPainted = !1, this._android = n(), this._htOption = b, this._elCanvas = document.createElement("canvas"), this._elCanvas.width = b.width+50, this._elCanvas.height = b.height+50, a.appendChild(this._elCanvas), this._el = a, this._oContext = this._elCanvas.getContext("2d"), this._bIsPainted = !1, this._elImage = document.createElement("img"), this._elImage.style.display = "none", this._el.appendChild(this._elImage), this._bSupportDataURI = null
            };
            return e.prototype.draw = function(a) {
                ...
                ,this._oContext.rect(0, 0, 250, 250)
                ,this._oContext.fillStyle = "white"
                ,this._oContext.fill()
